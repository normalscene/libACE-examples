...
#ifndef _TYPE_DEF_
#define _TYPE_DEF_
typedef char                int8_t;       //c
typedef short               int16_t;      //s
typedef int                 int32_t;      //l
typedef unsigned char       uint8_t;      //uc
typedef unsigned short      uint16_t;     //us
typedef unsigned int        uint32_t;     //ul
...
// 转换帧侧与用户侧数据结构的函数指针类型
// pusLen 为封装成帧侧的数据字节长
typedef eMtErr (*pMtFunc)(eMtTrans eTrans, void* pUser, void* pFrame, uint16_t* pusLen);  
///*} 
...
#if MT_CFG_ENCRYPT
// 加密函数类型
typedef eMtErr (*peMtEncryptFunc)(uint8_t* pInData, int nInLen, uint8_t* pOutData, int *pOutLen);  

// 解密函数类型
typedef eMtErr (*peMtDecryptFunc)(uint8_t* pInData, int nInLen, uint8_t* pOutData, int *pOutLen);  
#endif
///*} 
...
// 转换函数
eMtErr emt_trans_XXXX(eMtTrans eTrans, uint16_t* psUser, sMtFmt08* psFrame);
///*} 
...
// 转换函数
eMtErr emt_trans_XXXXXX(eMtTrans eTrans, uint32_t* psUser, sMtFmt_XXXXXX* psFrame);
///*} 
...
// 转换函数
eMtErr emt_trans_XX_6(eMtTrans eTrans, uint8_t* psUser, sMtFmt_XX_6* psFrame);
///*}
...
// 转换函数
eMtErr emt_trans_XXXXXXXX(eMtTrans eTrans, uint32_t* psUser, sMtFmt_XXXXXXXX* psFrame);
///*} 
...
// 转换函数
eMtErr emt_trans_fmt_freeze(eMtTrans eTrans, eMtFmtFrez* psUser, uint8_t* psFrame);
///*} 
...
int    bmt_get_float_sign(float fVal);      

// 设置一个浮点数的符号位 sign = -1 / +1
void   vmt_set_float_sign(float *pfVal, int sign);  
///*}
...
int    bmt_get_double_sign(double dVal);       
 
// 设置一个浮点数的符号位 sign = -1 / +1
void   vmt_set_double_sign(double *pdVal, int sign);  
///*}
///*} 
...
// 转换函数
eMtErr emt_add_cmdpn(sMtCmdPn* psCmdPn,sMtCmdPn sNewCmdPn, uint8_t *pucNumCmdPn);
eMtErr emt_pnfn_to_cmdpn(eMtAFN eAfn, sMtPnFn* psPnFn, uint8_t ucNumPnFn,   sMtCmdPn* psCmdPn, uint8_t *pucNumCmdPn);
eMtErr emt_cmdpn_to_pnfn(eMtAFN eAfn, sMtPnFn* psPnFn, uint8_t *pucNumPnFn, sMtCmdPn* psCmdPn, uint8_t  ucNumCmdPn);
eMtErr emt_dadt_to_cmdpn(eMtAFN eAfn, sMtDaDt* psDaDt, uint8_t ucNumDaDt,   sMtCmdPn* psCmdPn, uint8_t *pucNumCmdPn);
eMtErr emt_cmdpn_to_dadt(eMtAFN eAfn, sMtDaDt* psDaDt, uint8_t *pucNumDaDt, sMtCmdPn* psCmdPn, uint8_t  ucNumCmdPn);
///*}
...
// 转换函数
eMtErr emt_trans_ctrl(eMtTrans eTrans, sMtCtrl* puCtrl, uint8_t* pfCtrl);
...
// 获得当前用户侧Tp原始数据 
eMtErr emt_get_tp(uint8_t ucPFC, sMtTP *psuTp);   

// 以当前时间为基准判断一个tp是否超时
bool  bmt_tp_timeout(sMtTP *psTP);

// 获得当前报文类型对应的aux(tp ec pw)总字长
uint16_t usmt_get_aux_len(eMtAFN eAFN, eMtDir eDir, bool bEc, bool bTp); 
///*}
...
eMtErr emt_get_cmd_info(eMtCmd eCmd, eMtDir eDir, sMtCmdInfor* psInfor);
...
#pragma pack()
// 转换函数
eMtErr emt_trans_OneByOne(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn03f1(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f1(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f2(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f3(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f4(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f5(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f6(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f7(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f8(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f9(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f10(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f11(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f12(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f13(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
#pragma pack() 
// 转换函数
eMtErr emt_trans_afn04f14(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f15(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f16(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f17(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f18(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f19(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f20(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f21(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f22(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f23(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f25(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f26(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f27(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f28(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f29(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f30(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f31(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f33(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f34(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f35(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f36(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f37(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f38(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f39(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f41(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f42(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f43(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f44(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f45(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f46(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f47(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f48(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f49(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f57(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f58(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f59(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f60(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f61(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn04f65(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f66(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f67(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
#pragma pack() 
// 转换函数
eMtErr emt_trans_afn04f68(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f73(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f74(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f75(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f76(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f81(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f82(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn04f83(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f1(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f9(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f12(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f25(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f31(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f32(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f41(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f42(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f49(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f50(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f51(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f52(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn05f53(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn06f1(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn06f2(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn06f3(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn06f4(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn09f1(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn09f2(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn09f3(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 辅助函数
eMtErr emt_trans_afn09f4_ast(eMtTrans eTrans,eMtCmd eCmd, uint8_t *pArray, uint8_t *pucTeam);

// 转换函数
eMtErr emt_trans_afn09f4(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 辅助函数
eMtErr emt_trans_afn09f5_ast(eMtTrans eTrans,eMtCmd eCmd, uint8_t *pArray, uint8_t *pucTeam);

// 转换函数
eMtErr emt_trans_afn09f5(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 辅助函数
eMtErr emt_trans_afn09f6_ast(eMtTrans eTrans,eMtCmd eCmd, uint8_t *pArray, uint8_t *pucTeam);

// 转换函数
eMtErr emt_trans_afn09f6(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 辅助函数
eMtErr emt_trans_afn09f7_ast(eMtTrans eTrans,eMtCmd eCmd, uint8_t *pArray, uint8_t *pucTeam);

// 转换函数
eMtErr emt_trans_afn09f7(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn09f8(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0af10(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0af38(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0af39(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf02(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf03(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf04(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf05(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf06(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf07(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf08(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf09(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf10(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf11(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf17(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf18(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf19(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf20(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf21(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf22(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf23(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf24(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf25(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
...
eMtErr emt_trans_afn0cf26(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf27(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf28(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf29(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
eMtErr emt_trans_afn0cf30(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf31(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf32(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf33(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf34(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf35(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf36(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf37(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf38(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf39(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf40(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf41(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf42(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf43(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf44(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf45(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf46(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf47(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf48(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf49(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
#pragma pack() 
// 转换函数
eMtErr emt_trans_afn0cf57(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf58(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf65(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf66(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf67(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf73(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf81(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf82(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf83(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf84(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf89(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf90(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf91(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf92(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf93(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf94(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf95(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf96(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf97(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf98(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf99(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf100(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf101(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf102(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf103(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf105(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf106(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf107(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf108(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf109(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf110(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf111(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf112(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf113(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf114(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf115(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf116(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf121(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf129(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
#pragma pack() 
// 转换函数
eMtErr emt_trans_afn0cf130(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf131(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf132(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf133(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf134(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf135(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf136(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf137(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf138(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf139(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf140(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf141(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf142(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf143(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf144(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf145(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf146(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf147(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf148(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf149(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf150(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf151(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf152(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf153(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf154(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf155(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf156(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf157(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf158(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf159(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf160(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf161(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf165(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf166(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf167(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf168(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf169(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0cf170(eMtTrans eTrans,void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_td_h(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_td_c(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_td_d(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_td_m(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df1(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df2(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df3(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df4(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df5(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df6(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df7(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df8(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df9(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df10(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df11(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df12(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df17(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df18(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df19(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df20(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df21(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df22(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df23(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df24(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df25(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df26(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df27(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df28(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df29(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df30(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df31(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df32(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df33(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df34(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df35(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df36(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df37(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df38(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df39(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df41(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df42(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df43(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df44(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df97(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df98(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df99(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df100(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df101(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df102(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df103(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df104(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df105(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df106(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df107(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df108(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df109(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df110(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df113(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df114(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df115(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df116(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df117(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df118(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df121(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df122(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df123(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df129(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df130(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df138(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df145(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df146(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df147(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df148(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df153(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df154(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df155(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df156(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df157(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df158(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df159(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df160(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df161(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df162(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df163(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df164(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df165(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df166(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df167(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df168(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df169(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df170(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df171(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df172(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df173(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df174(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df175(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df176(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df177(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df178(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df179(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df180(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df181(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df182(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df183(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df184(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df185(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df186(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df187(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df188(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df189(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df190(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df191(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df192(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df193(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df194(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df195(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df196(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df201(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df202(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df203(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df204(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df205(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df206(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df207(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df208(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df209(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df213(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df214(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df215(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df216(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df217(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_afn0df218(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_1(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_2(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
...
// 转换函数
eMtErr emt_trans_rec_3(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
...
// 转换函数
eMtErr emt_trans_rec_4(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_5(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_6(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_7(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_8(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_9(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_10(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_11(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_12(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_13(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_14(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_15(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_16(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_17(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_18(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_19(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_20(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_21(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_22(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_23(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_24(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_25(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_26(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_27(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_28(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_29(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_30(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_31(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_32(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_33(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_34(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
...
// 转换函数
eMtErr emt_trans_rec_35(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
///*}
///*}
...
// 转换函数
eMtErr emt_trans_afn0ef1_m2s(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
eMtErr emt_trans_afn0ef1_s2m(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);

// 辅助函数
pMtFunc pmt_get_record_trans_func(uint8_t ucRecID);
///*}
...
// 转换函数
eMtErr emt_trans_afn0ef2_m2s(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
eMtErr emt_trans_afn0ef2_s2m(eMtTrans eTrans, void* psUser, void* psFrame, uint16_t* pusfLen);
 ...
 *
{*///
eMtErr emt_str_to_bcd(const uint8_t* pstr, uint8_t* pbcd, int32_t len); 
eMtErr emt_bcd_to_str(const uint8_t* pbcd, uint8_t* pstr, int32_t len);
///*}
...
eMtErr emt_write_uint16_small_endian(uint16_t usData, uint8_t* pWrite);  

// 将一个UINT32数值字小字节序写入地址pWrite
eMtErr emt_write_uint32_small_endian(uint32_t ulData, uint8_t* pWrite); 

// 从指定地址位置以小字节序的方式读入一个整数
eMtErr emt_read_uint16_small_endian(uint8_t* pRead, uint16_t* pUint16);

// 从指定地址位置以小字节序的方式读入一个长整数
eMtErr emt_read_uint32_small_endian(uint8_t* pRead, uint32_t* pUint32);  
///*}
...
// 封帧函数
eMtErr emt_lite_pack(smtLitePack* psPack, uint16_t* pusLen, uint8_t* pOutBuf);   

// 解帧函数
eMtErr emt_lite_unpack(smtLitePack *psUnpack, uint8_t* pInBuf, uint16_t usLen);
///*}
...
// 根据总加组有效标志位获取总加组个数
uint8_t emt_get_group_number(uint8_t ucGroupFlag);
...
// 封帧函数
eMtErr emt_base_pack(smtBasePack* psPack, uint16_t* pusLen, uint8_t* pOutBuf);   

// 解帧函数
eMtErr emt_base_unpack(smtBasePack *psUnpack, uint8_t* pInBuf, uint16_t usLen);
///*}
...
// 封装每个帧的公共部分 
eMtErr emt_pack_common(eMtAFN eAFN, sMtComPack *psCommon,  uint16_t *pusLen, uint8_t  *pOutBuf); 
...
eMtErr emt_unpack_common(sMtUnpackCommon *psUnpack, uint8_t* pInBuf, uint16_t usLen);
...
// 获得该类型的报文的主动性
eMtPRM emt_get_prm(eMtDir eDir, eMtAFN eAfn, bool bAuto);

// 判断一个报文是否是有一个有效的376.1帧
eMtErr emt_is_valid_pack(const uint8_t* pOutBuf, uint16_t usLen);

// 从帧缓冲区中找到第一个有效的帧的位置及长度
eMtErr emt_find_valid_pack(uint8_t* pinBuf, uint16_t usLen, uint16_t* pusFirstOff, uint16_t* pusFirstLen);
...
// 获得我的身份
eMtRole emt_who_am_i();

// 获得命令对应的AFN
eMtAFN eGetCmdAfn(eMtCmd eCmd);

// 获得命令对应的Fn
uint8_t  uc_get_cmd_fn(eMtCmd eCmd);
/***************************************
 *  数据单元标识与对应的数据单元 (高级抽象)
 *  
 * 数据单元为按数据单元标识所组织的数据,包括参数、命令等。
...
// 封装函数
eMtErr emt_pack_base(smtPack* psPack, uint16_t* pusLen, uint8_t* pOutBuf);   

// 解帧函数
eMtErr emt_unpack_base(smtPack *psUnpack, uint8_t* pInBuf, uint16_t usLen);

// 封装函数
eMtErr emt_pack_lite(smtPack* psPack, uint16_t* pusLen, uint8_t* pOutBuf);   

// 解帧函数
eMtErr emt_unpack_lite(smtPack *psUnpack, uint8_t* pInBuf, uint16_t usLen);

// 高级接口
// 封装函数
eMtErr emt_pack(smtPack* psPack, uint16_t* pusLen, uint8_t* pOutBuf);   

// 解帧函数
eMtErr emt_unpack(smtPack *psUnpack, uint8_t* pInBuf, uint16_t usLen);
///*}
///*}
