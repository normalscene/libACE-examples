...
*****************************************************************************/
void print_buffer(uint8_t * pBuf, uint16_t* pusBufLen)
{
...
emt_err_t test_pack_0601()
{
    ...
    const char *strCiphertext = "abcdef1234567890";
    // app_data                                                  // (4)这里需要修改
...
int main(int argc, char *argv[])
{
    int opt = 0;
    int longIndex = 0;
    const char *strOpt = "uohcnmap:t:e:a:d:";
    int    iTest= 0;// 测试例ID
